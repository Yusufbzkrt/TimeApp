...
namespace TimeProject.Server.Migrations
{
    ...
    [Migration("20250521113147_AddAvaataupload")]
    partial class AddAvaataupload
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TimeProject.Server.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2025, 5, 21, 14, 31, 46, 151, DateTimeKind.Local).AddTicks(4688),
                            Email = "admin@example.com",
                            Name = "Yusuf",
                            PasswordHash = "$2a$11$oW9vLQSKSQX45SixX3QRF.f4XBoGI.TusYZI/mVpMSEvbOKBOi.5S",
                        ...
                        new
                        {
                            UserId = 2,
                            AccountStatusId = "Active",
                            CreateDate = new DateTime(2025, 5, 21, 14, 31, 46, 151, DateTimeKind.Local).AddTicks(4713),
                        ...
                        new
                        {
                            UserId = 3,
                            AccountStatusId = "Active",
                            CreateDate = new DateTime(2025, 5, 21, 14, 31, 46, 151, DateTimeKind.Local).AddTicks(4716),
