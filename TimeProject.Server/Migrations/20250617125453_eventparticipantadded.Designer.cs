...
namespace TimeProject.Server.Migrations
{
    ...
    [Migration("20250617125453_eventparticipantadded")]
            ...
            modelBuilder.Entity("TimeProject.Server.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2025, 6, 17, 15, 54, 53, 462, DateTimeKind.Local).AddTicks(3573),
                            Credit = 0,
                            Email = "admin@example.com",
                            Name = "Yusuf",
                            PasswordHash = "$2a$11$V3VdrXraDVow8NVzDScRpuA1Oi8G9oiwPBpI5GEc8uvRrRLefZgAu",
                        ...
                        new
                        {
                            UserId = 2,
                            AccountStatusId = "Active",
                            CreateDate = new DateTime(2025, 6, 17, 15, 54, 53, 462, DateTimeKind.Local).AddTicks(3598),
                            Credit = 0,
                        ...
                        new
                        {
                            UserId = 3,
                            AccountStatusId = "Active",
                            CreateDate = new DateTime(2025, 6, 17, 15, 54, 53, 462, DateTimeKind.Local).AddTicks(3600),
                            Credit = 0,
